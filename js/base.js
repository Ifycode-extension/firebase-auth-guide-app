...
import { getFirestore, collection, query, addDoc, onSnapshot } from "https://www.gstatic.com/firebasejs/9.2.0/firebase-firestore.js";
...
export { db, collection, query, addDoc, onSnapshot };
